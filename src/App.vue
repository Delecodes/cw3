<template>
  ...
  <Cart :cart="cart" :postOrder="postOrder" :switchPage="switchPages" v-on:removeFromCart="removeFromCart"></Cart>
         </div>
  </div>
</template>
...
console.log(this.lessons);
                ...
                async postOrder(){
 await fetch('http://coursework32-env.eba-ie2rhjbf.eu-west-2.elasticbeanstalk.com/order', {
    method: "POST",
    body: JSON.stringify({
...
console.log('successful');
        ...
        async updateLesson(){
            console.log(this.lessons);
           await fetch('http://coursework32-env.eba-ie2rhjbf.eu-west-2.elasticbeanstalk.com/', {
                method:'PUT',
